...
CHAPTER_MP3 = {
  ...
  "sections": [
    ...
    {"title": "핵심 개념 — ‘출력기’가 마지막 한 칸을 채운다", "items": [
      {"type": "text", "html": "코드를 짜기 전에, 오늘 쓰는 부품과 개념을 천천히 짚어요. 딱 네 가지만 이해하면 됩니다."},
      {"type": "concept", "items": [
    ...
    {"title": "2단계 · 음성 파일 만들어 SD카드에 넣기", "items": [
      ...
      {"type": "prompt", "label": "AI에게 TTS 음성 만들기 시키기 (그대로 복사)",
       "text": "휘파람·박수·말소리·노크, 이 네 가지에 대해 한국어로 한 마디씩 멘트(예: '휘파람이에요', '박수네요', '말소리예요', '노크 소리예요')를 읽어주는 mp3 파일을 만들고 싶어. 무료 TTS로 만드는 구체적인 방법(사이트나 앱 추천 포함)을 알려주고, 파일 이름을 0001.mp3~0004.mp3로 붙이는 순서까지 정리해줘. 음성은 너무 길지 않게 1~2초로."},
    ...
    {"title": "4단계 · 분류 결과를 ‘목소리’로 (메인 완성)", "items": [
      ...
      {"type": "prompt", "label": "막히면 AI에게 (바이브코딩)",
       "text": "이 MicroPython 코드는 마이크로 소리를 k-NN으로 분류한 뒤 Grove MP3 v4.0(WT2605CX, AT 명령 'AT+PLAY=sd0,N', 115200 baud)로 라벨에 맞는 트랙을 재생해. 소리가 안 나오거나 엉뚱한 곡이 나오면 어디를 점검해야 하는지, TRACK 사전과 SD카드 파일 번호를 맞추는 법, 자기 소리 되먹임을 막는 SPEAK_SEC 값을 어떻게 조절할지 알려줘."},
    ]},
