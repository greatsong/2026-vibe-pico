...
CHAPTER_MP3 = {
  ...
  "sections": [
    ...
    {"title": "🎛️ 피날레 — 소리 ML 컨트롤 센터 (모든 걸 한 화면에서)", "items": [
      ...
      {"type": "callout", "kind": "warn", "title": "환경이 바뀌면 — 데이터부터 새로!",
       "html": "마이크의 위치·장소·배경소음이 바뀌면 <b>같은 소리라도 숫자 스케일이 달라져</b> 예측이 엉뚱해질 수 있어요. 그럴 땐 대시보드에서 <b>[전체 지우기]</b> 후 지금 환경에서 다시 모으세요. ‘좋은 데이터가 좋은 AI를 만든다’는 여기서도 그대로예요."},
      {"type": "steps", "items": [
      ...
      {"type": "callout", "kind": "warn", "title": "이 코드는 가장 복잡 — 실기 점검 1회 권장",
       "html": "마이크 + 와이파이 서버를 동시에 다뤄 <b>이 책에서 가장 복잡</b>해요. 안 되면: ① <code>wifi_config</code> 정보 ② 폰·피코가 같은 와이파이인지 ③ 그래프가 안 뜨면 <b>브라우저 인터넷</b>(Plotly CDN). 콘솔판(<code>sound_record_i2s.py</code>)은 와이파이 없이도 되는 안전한 대안이에요."},
    ]},
  ],
}
