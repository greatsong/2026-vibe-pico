...
<svg class="api-svg" viewBox="0 0 760 500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" role="img" aria-label="클릭하면 신청서가 가고 결과물이 돌아오는 API 비유 애니메이션">
  <defs>
    <marker id="arR" markerWidth="9" markerHeight="9" refX="7" refY="4.5" orient="auto"><path d="M0,0 L9,4.5 L0,9 z" fill="#9fb0f5"/></marker>
    <marker id="arL" markerWidth="9" markerHeight="9" refX="7" refY="4.5" orient="auto"><path d="M0,0 L9,4.5 L0,9 z" fill="#f0b9d2"/></marker>
  ...
  <text x="380" y="76" text-anchor="middle" font-size="11.5" font-weight="800" fill="#3b47c2" style="pointer-events:none">👆 ‘비유’ 클릭 — 등본 신청해 보기</text>
  ...
  <path id="goA" d="M170,138 Q380,86 590,138" fill="none" stroke="#9fb0f5" stroke-width="2" marker-end="url(#arR)" style="pointer-events:none"/>
  <text x="380" y="82" text-anchor="middle" font-size="10" fill="#5B6CF0" font-weight="700" style="pointer-events:none">요청(신청서) →</text>
  <path id="retA" d="M590,162 Q380,214 170,162" fill="none" stroke="#f0b9d2" stroke-width="2" marker-end="url(#arL)" style="pointer-events:none"/>
  <text x="380" y="228" text-anchor="middle" font-size="10" fill="#E0568A" font-weight="700" style="pointer-events:none">← 응답(결과물)</text>
  <g opacity="0" style="pointer-events:none">
    <rect x="-36" y="-25" width="72" height="50" rx="5" fill="#ffffff" stroke="#b9c0f5"/>
    <rect x="-36" y="-25" width="72" height="12" rx="5" fill="#5B6CF0"/><rect x="-36" y="-19" width="72" height="6" fill="#5B6CF0"/>
    <text x="0" y="-15" text-anchor="middle" font-size="7.5" font-weight="700" fill="#ffffff">📝 등본 신청서</text>
    <text x="0" y="-2" text-anchor="middle" font-size="8" font-weight="700" fill="#3b47c2" opacity="0">이름: 홍길동<animate attributeName="opacity" begin="reqMoveA.begin" dur="2.4s" keyTimes="0;0.08;0.14;1" values="0;0;1;1"/></text>
    <text x="0" y="9" text-anchor="middle" font-size="8" font-weight="700" fill="#3b47c2" opacity="0">주소: 서울 ○○구<animate attributeName="opacity" begin="reqMoveA.begin" dur="2.4s" keyTimes="0;0.16;0.22;1" values="0;0;1;1"/></text>
    <animate attributeName="opacity" begin="reqMoveA.begin" dur="2.4s" keyTimes="0;0.05;0.30;0.85;1" values="0;1;1;1;0"/>
    <animateMotion id="reqMoveA" begin="indefinite" dur="2.4s" calcMode="linear" keyTimes="0;0.30;1" keyPoints="0;0;1"><mpath xlink:href="#goA"/></animateMotion>
  </g>
  <g opacity="0" style="pointer-events:none">
    ...
    <text x="0" y="-16" text-anchor="middle" font-size="7.5" font-weight="700" fill="#ffffff">📄 주민등록등본</text>
    ...
    <animateMotion begin="reqMoveA.end" dur="2.4s" calcMode="spline" keyTimes="0;1" keyPoints="0;1" keySplines="0.4 0 0.2 1"><mpath xlink:href="#retA"/></animateMotion>
  </g>
  ...
  <text x="380" y="298" text-anchor="middle" font-size="11.5" font-weight="800" fill="#0e9488" style="pointer-events:none">👆 ‘피코’ 클릭 — 강수확률 받아 보기</text>
  ...
  <path id="goB" d="M170,360 Q380,308 590,360" fill="none" stroke="#9fb0f5" stroke-width="2" marker-end="url(#arR)" style="pointer-events:none"/>
  <text x="380" y="304" text-anchor="middle" font-size="10" fill="#5B6CF0" font-weight="700" style="pointer-events:none">요청(신청서) →</text>
  <path id="retB" d="M590,384 Q380,436 170,384" fill="none" stroke="#f0b9d2" stroke-width="2" marker-end="url(#arL)" style="pointer-events:none"/>
  <text x="380" y="450" text-anchor="middle" font-size="10" fill="#E0568A" font-weight="700" style="pointer-events:none">← 응답(결과물)</text>
  <g opacity="0" style="pointer-events:none">
    <rect x="-36" y="-25" width="72" height="50" rx="5" fill="#ffffff" stroke="#b9c0f5"/>
    <rect x="-36" y="-25" width="72" height="12" rx="5" fill="#0e9488"/><rect x="-36" y="-19" width="72" height="6" fill="#0e9488"/>
    <text x="0" y="-15" text-anchor="middle" font-size="7.5" font-weight="700" fill="#ffffff">📝 요청 (URL)</text>
    <text x="0" y="-2" text-anchor="middle" font-size="8" font-weight="700" fill="#3b47c2" opacity="0">위도: 37.5<animate attributeName="opacity" begin="reqMoveB.begin" dur="2.4s" keyTimes="0;0.06;0.12;1" values="0;0;1;1"/></text>
    <text x="0" y="9" text-anchor="middle" font-size="8" font-weight="700" fill="#3b47c2" opacity="0">경도: 127<animate attributeName="opacity" begin="reqMoveB.begin" dur="2.4s" keyTimes="0;0.12;0.18;1" values="0;0;1;1"/></text>
    <text x="0" y="20" text-anchor="middle" font-size="8" font-weight="700" fill="#3b47c2" opacity="0">시간: 15시<animate attributeName="opacity" begin="reqMoveB.begin" dur="2.4s" keyTimes="0;0.18;0.24;1" values="0;0;1;1"/></text>
    <animate attributeName="opacity" begin="reqMoveB.begin" dur="2.4s" keyTimes="0;0.05;0.30;0.85;1" values="0;1;1;1;0"/>
    <animateMotion id="reqMoveB" begin="indefinite" dur="2.4s" calcMode="linear" keyTimes="0;0.30;1" keyPoints="0;0;1"><mpath xlink:href="#goB"/></animateMotion>
  </g>
  <g opacity="0" style="pointer-events:none">
    <rect x="-36" y="-26" width="72" height="52" rx="5" fill="#ffffff" stroke="#f0c6da"/>
    <rect x="-36" y="-26" width="72" height="12" rx="5" fill="#0e9488"/><rect x="-36" y="-20" width="72" height="6" fill="#0e9488"/>
    <text x="0" y="-16" text-anchor="middle" font-size="7.5" font-weight="700" fill="#ffffff">📦 응답 (JSON)</text>
    ...
    <animateMotion begin="reqMoveB.end" dur="2.4s" calcMode="spline" keyTimes="0;1" keyPoints="0;1" keySplines="0.4 0 0.2 1"><mpath xlink:href="#retB"/></animateMotion>
  </g>
...
<p style="margin:10px 0 0;font-size:12.5px;color:#7a7f95">한 번 클릭 = 한 번 왕복(요청→응답). 우리 코드는 ‘피코가 동사무소에서 <b>오늘 강수확률 등본</b>을 떼 오는 것’ — <b>정보과학</b>(요청→응답)과 <b>과학</b>(데이터 탐구)이 만나는 지점이에요.</p>'''
