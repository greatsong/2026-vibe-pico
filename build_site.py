...
<svg class="api-svg" viewBox="0 0 760 470" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="등본 떼기 비유와 실제 API(위도·경도·시간으로 강수확률 받기)를 나란히 보여주는 애니메이션">
  ...
  <circle r="5" cy="150" fill="#5B6CF0" opacity="0.9"><animate attributeName="cx" dur="6s" repeatCount="indefinite" keyTimes="0;0.5;1" values="196;564;196" calcMode="spline" keySplines="0.42 0 0.58 1;0.42 0 0.58 1"/></circle>
  <!-- 등본 신청서 -->
  <g opacity="0">
  ...
  <circle r="5" cy="346" fill="#0e9488" opacity="0.9"><animate attributeName="cx" dur="6s" repeatCount="indefinite" keyTimes="0;0.5;1" values="196;564;196" calcMode="spline" keySplines="0.42 0 0.58 1;0.42 0 0.58 1"/></circle>
  <!-- 요청(URL) -->
  <g opacity="0">
