...
# ----------------------------------------------------------------- CH2
{
  ...
  "sections": [
    ...
    {"title": "내 감정 표현하기 (이 장의 작품)", "items": [
      {"type": "text", "html": "이제 배운 걸 모아 <b>감정 무드등</b>을 만들어요. 색은 ‘무슨 감정인지’, 움직임(숨쉬기·깜빡임·반짝임)은 ‘감정의 느낌·세기’를 나타냅니다. 우리 키트엔 버튼이 없으니, 코드 맨 아래 <code>MOOD</code> 한 줄만 바꿔서 기분을 골라요."},
...
# ----------------------------------------------------------------- CH4 (MQ-2 × LED)
{
  ...
  "sections": [
    ...
    {"title": "따라하기", "items": [
      {"type": "step_head", "html": "2장에서 만든 <b>게이지</b>(켜진 칸 수로 양을 나타내기)를 떠올리며, 센서값을 칸 수로 바꾸고 구간별로 색을 정합니다. 아래가 <b>복사하면 바로 도는</b> 완결형 코드예요. (와이파이 불필요 · LED만 있으면 동작)"},
      ...
      {"type": "callout", "kind": "tip", "title": "웹 + LED를 한 번에 보고 싶다면",
       "html": "앞 장(웹 대시보드)과 이 장(LED)을 합치고 싶다면 바이브코딩으로 부탁해 보세요: <b>‘앞 장 MQ-2 웹 대시보드 코드에, GP16의 WS2813 LED 10개(timing=(280,515,515,745)) 게이지를 더해 줘. 안전=초록·주의=노랑·위험=빨강 깜빡으로, 웹과 LED가 같은 값을 쓰게.’</b> 받은 코드에 timing이 있는지 꼭 확인하세요."},
    ]},
    {"title": "자주 하는 실수", "items": [
      {"type": "mistakes", "items": [
...
# ----------------------------------------------------------------- CH5 (날씨 API × LED)
{
  ...
  "sections": [
    ...
    {"title": "따라하기", "items": [
      ...
      {"type": "code", "label": "Step 2 · 강수확률 받아오기", "lang": "python", "file": "snippets/ch5_fetch.py"},
