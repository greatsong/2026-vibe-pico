...
CHAPTER_SOUND = {
  ...
  "sections": [
    ...
    {"title": "하드웨어 준비 — 마이크 연결하기 (아주 자세히)", "items": [
      ...
      {"type": "step_head", "html": "🔵 <b>경로 B · INMP441</b> — 음질 업그레이드 (점퍼 5선)"},
      {"type": "callout", "kind": "warn", "title": "먼저! VDD는 반드시 3.3V — 5V 금지",
       "html": "INMP441은 3.3V 소자라 <b>VDD를 5V에 꽂으면 망가집니다.</b> 쉴드가 피코 40핀을 모두 헤더로 뽑아주니, 그 헤더에 점퍼선(암-수)을 꽂으면 돼요. (색은 헷갈리지 않게 정한 것일 뿐, 달라도 됩니다.)"},
      {"type": "steps", "items": [
        {"t": "VDD → 3V3", "d": "빨강 점퍼 — <b>⚠ 5V 아님!</b>"},
        {"t": "GND → GND", "d": "검정 점퍼"},
        {"t": "SCK → GP18", "d": "노랑 점퍼"},
        {"t": "WS → GP19", "d": "파랑 점퍼 — <b>반드시 SCK 바로 다음 핀</b>"},
        {"t": "SD → GP20", "d": "초록 점퍼"},
        {"t": "L/R → GND", "d": "회색 점퍼 — 왼쪽 채널"},
      ]},
    ...
    {"title": "🎛️ 피날레 — 소리 ML 컨트롤 센터 (모든 걸 한 화면에서)", "items": [
      {"type": "text", "html": "마지막! 지금까지 배운 걸 <b>전부 한 화면에 모읍니다.</b> 폰/PC 브라우저에서 — <b>🔊 지금 들리는 소리 보기 · 녹음(+즉시 분류) · 실시간 3D 지도 · 예측 · k 조절 · 지우기</b>까지 모두 컨트롤! 1·3·5장처럼 <b>피코가 웹서버</b>가 됩니다. (피코 2 WH의 와이파이)"},
      {"type": "concept", "items": [
